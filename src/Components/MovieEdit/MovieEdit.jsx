        ...
        <>
            <Modal show={show} handleClose={handleClose}>
                <form onSubmit={(e) => { formik.handleSubmit(); e.preventDefault(); }}>
                    ...
                    <Input name="releaseDate" type="date" label="Release Date" placeholder="Select Date" value={formik.values.release_date} onChange={formik.handleChange} validationError={formik.errors.release_date} />
